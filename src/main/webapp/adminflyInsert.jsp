...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="indexadmin.jsp">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="adminflyDesign.jsp">航班管理</a><span class="crumb-step">&gt;</span><span>新增航班</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="addFlight" method="post" name="flight">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th width="120"><i class="require-red"></i>航班id：</th>
                                <td>
                                    <input class="common-text required" id="flightId" name="flightId" size="50" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th width="120"><i class="require-red"></i>出发地：</th>
                                <td><input class="common-text" name="origin" id="origin" size="50"  type="text"></td>
                            </tr>
                             <tr>
                                <th width="120"><i class="require-red"></i>目的地：</th>
                                <td>
                                    <input class="common-text required" id="destination" name="destination" size="50" type="text">
                                </td>
                            </tr>
                             <tr>
                                <th width="120"><i class="require-red"></i>出发时间：</th>
                                <td>
                                    <input class="common-text required" name="originTime" id="originTime" size="50" type="date">
                                </td>
                            </tr>
                             <tr>
                                <th width="120"><i class="require-red"></i>到达时间：</th>
                                <td>
                                    <input class="common-text required" id="destinationTime" name="destinationTime" size="50"  type="date">
                                </td>
                            </tr>
                             <tr>
                             ...
                             <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="airId" name="airId" size="50" type="text">
                                </td>
                            </tr>
