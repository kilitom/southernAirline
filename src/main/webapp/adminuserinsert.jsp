...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="indexadmin.jsp">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="adminuserDesign.jsp">用户管理</a><span class="crumb-step">&gt;</span><span>新增用户</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form name="user" action="insertUser"  method="post" id="user" onsubmit="return checkUser()">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th width="120"><i class="require-red"></i>用户姓名：</th>
                                <td><input name="username" id="username" class="common-text" size="50" type="text"></td>
                            </tr>
                             <tr>
                                <th width="120"><i class="require-red"></i>用户密码：</th>
                                <td>
                                    <input name="password" id="password" class="common-text required" size="50" type="password">
                                </td>
                            </tr>
                             <tr>
                                <th width="120"><i class="require-red"></i>用户性别：</th>
                                <td>
                                    <input name="sex" id="sex" class="common-text required" size="50"  type="text">
                                </td>
                            </tr>
                             <tr>
                                <th width="120"><i class="require-red"></i>电话：</th>
                                <td>
                                    <input name="phone" id="phone" class="common-text required" size="50" type="tel">
                                </td>
                            </tr>
                             <tr>
                                <th width="120"><i class="require-red"></i>身份证号：</th>
                                <td>
                                    <input name="uid" id="uid" class="common-text required" size="50" type="text">
                                </td>
                            </tr>
                             <tr>
                                <th width="120"><i class="require-red"></i>邮箱：</th>
                                <td>
                                    <input name="email" id="email" class="common-text required" size="50" type="text">
                                </td>
                            </tr>
                             <tr>
                                <th width="120"><i class="require-red"></i>生日：</th>
                                <td>
                                    <input name="birth" id="birth" class="common-text required" size="50" type="date">
                                </td>
                            </tr>
                            <span>${msg}</span>
                            <tr>
